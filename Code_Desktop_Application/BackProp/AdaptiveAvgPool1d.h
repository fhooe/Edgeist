...
public:
	...
	// Initialisiere Dropout maske für mini batch
	...
	virtual uint32_t getOutputSize() override {
		return this->mHeader->channelsin * this->mHeader->dimensionoutput_x;
	}

	virtual uint32_t getInputSize() override {
		return this->mHeader->channelsin * this->mHeader->dimensioninput_x;
	}
