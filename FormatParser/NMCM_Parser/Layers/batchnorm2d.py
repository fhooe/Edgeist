...
from Utils.helper_functions import Datatype
...
class BatchNorm2d(Layer):
    ...
    def define_data(self, idx : int, modelinfo, masks : Masks = None):
        ...
        self.data["DimensionInput_x"] = modelinfo["input_shape"][1] * modelinfo["input_shape"][2] * modelinfo["input_shape"][3] # Input width
        self.data["DimensionOutput_x"] = modelinfo["output_shape"][1] * modelinfo["output_shape"][2] * modelinfo["output_shape"][3]  # Output width
        ...
        self.data["Weights_amount_trainable"] = (len(weights["trainable"]) if "trainable" in weights else 0) + len(running_mean)
